...
public class ScoreLowThenDriveOffTarmac extends SequentialCommandGroup {
  /** Creates a new ScoreThenDriveOffTarmac. */
  public ScoreLowThenDriveOffTarmac(Manipulator manipulator, double manipulatorPower,
